...
@Component({
  ...
  template: `
    <div class="bg-gradient-to-br from-blue-50 to-indigo-100 min-h-[calc(100vh-200px)]">
      <!-- Hero Section -->
        ...
        <div class="max-w-7xl mx-auto text-center">
          ...
          <div class="space-y-4 sm:space-y-0 sm:space-x-4 sm:flex sm:justify-center">
            <a routerLink="/services" 
               class="inline-block bg-blue-600 text-white px-8 py-3 rounded-lg text-lg font-medium hover:bg-blue-700 transform hover:scale-105 transition-all duration-200 shadow-lg">
              {{ 'HOME.HERO.CTA_SERVICES' | translate }}
            </a>
            <a routerLink="/contact" 
               class="inline-block bg-white text-blue-600 border-2 border-blue-600 px-8 py-3 rounded-lg text-lg font-medium hover:bg-blue-600 hover:text-white transition-all duration-200">
